...
class Order {
  ...
  static async findAll(filters = {}, pagination = {}) {
    ...
    // Only apply pagination if pagination parameters are provided
    const paginationClause = (pagination.page && pagination.limit)
      ? buildPaginationClause(pagination.page, pagination.limit)
      : '';
